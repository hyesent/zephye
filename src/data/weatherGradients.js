// ============================================================================
// WEATHER GRADIENTS + SVG ART — VISIBLE + RESTRAINED
// ============================================================================
  ...
  const svgs = {
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="sunGlow" cx="50%" cy="16%" r="35%">
            ...
            <stop offset="45%" stop-color="#FFE4A0" stop-opacity="0.28"/>
            <stop offset="100%" stop-color="#FDB813" stop-opacity="0"/>
          </radialGradient>
        </defs>
        <ellipse cx="${w * 0.5}" cy="${h * 0.16}" rx="${w * 0.45}" ry="${h * 0.30}" fill="url(#sunGlow)"/>
        <circle cx="${w * 0.5}" cy="${h * 0.16}" r="${w * 0.07}" fill="#FFF8DC" opacity="0.85"/>
        <circle cx="${w * 0.5}" cy="${h * 0.16}" r="${w * 0.045}" fill="#FFFFFF" opacity="0.95"/>
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="moonGlow" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="50%" stop-color="#A0C4FF" stop-opacity="0.15"/>
            <stop offset="100%" stop-color="#A0C4FF" stop-opacity="0"/>
          </radialGradient>
        </defs>
        <circle cx="${w * 0.75}" cy="${h * 0.22}" r="${w * 0.16}" fill="url(#moonGlow)"/>
        <circle cx="${w * 0.75}" cy="${h * 0.22}" r="${w * 0.06}" fill="#F5F5F5" opacity="0.9"/>
        <circle cx="${w * 0.72}" cy="${h * 0.20}" r="${w * 0.014}" fill="#D8D8D8" opacity="0.5"/>
        <circle cx="${w * 0.77}" cy="${h * 0.24}" r="${w * 0.010}" fill="#D8D8D8" opacity="0.4"/>
        ${(() => {
          const stars = []
          for (let i = 0; i < 15; i++) {
            const { x, y } = edgeBiasedPosition(i * 7 + 100, w, h, 0.04, 0.42)
            const r = seededRandom(i * 11 + 1) * 1.4 + 0.4
            const opacity = 0.4 + seededRandom(i * 13 + 2) * 0.25
    ...
    partlyCloudyDay: `
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="${w * 0.72}" cy="${h * 0.18}" r="${w * 0.045}" fill="#FFF8DC" opacity="0.85"/>
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ${(() => {
          ...
          for (let i = 0; i < 12; i++) {
            ...
            const opacity = 0.35 + seededRandom(i * 19 + 6) * 0.2
            stars.push(`<circle cx="${x}" cy="${y}" r="${r}" fill="#FFFFFF" opacity="${opacity}"/>`)
          }
          return stars.join('')
        })()}
        <circle cx="${w * 0.75}" cy="${h * 0.20}" r="${w * 0.13}" fill="#A0C4FF" opacity="0.25"/>
        <circle cx="${w * 0.75}" cy="${h * 0.20}" r="${w * 0.045}" fill="#F5F5F5" opacity="0.85"/>
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ...
        ${(() => {
          ...
          for (let i = 0; i < 26; i++) {
            ...
            const opacity = 0.35 + seededRandom(i * 31 + 9) * 0.15
            drops.push(`<line x1="${x}" y1="${y}" x2="${x - 5}" y2="${y + len}" stroke="#7DB8E8" stroke-width="1.5" stroke-linecap="round" opacity="${opacity}"/>`)
          }
          return drops.join('')
        })()}
      </svg>
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ...
        ${(() => {
          ...
          for (let i = 0; i < 26; i++) {
            ...
            const opacity = 0.3 + seededRandom(i * 41 + 11) * 0.15
            drops.push(`<line x1="${x}" y1="${y}" x2="${x - 5}" y2="${y + len}" stroke="#5A8FB8" stroke-width="1.5" stroke-linecap="round" opacity="${opacity}"/>`)
          }
          return drops.join('')
        })()}
      </svg>
    ...
    thunderDay: `
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.55" filter="blur(4px)">
        ...
        <g filter="url(#lightningGlow)" opacity="0.9">
        ...
        ${(() => {
          ...
          for (let i = 0; i < 14; i++) {
            ...
            drops.push(`<line x1="${x}" y1="${y}" x2="${x - 4}" y2="${y + len}" stroke="#5A8FB8" stroke-width="1.2" stroke-linecap="round" opacity="0.35"/>`)
          }
          return drops.join('')
        })()}
      </svg>
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ${(() => {
          ...
          for (let i = 0; i < 6; i++) {
            ...
            stars.push(`<circle cx="${x}" cy="${y}" r="1" fill="#FFFFFF" opacity="0.4"/>`)
          }
          return stars.join('')
        })()}
        <g opacity="0.55" filter="blur(4px)">
        ...
        <g filter="url(#lightningGlowNight)" opacity="0.95">
          <path d="M ${w * 0.68} ${h * 0.30} L ${w * 0.64} ${h * 0.52} L ${w * 0.69} ${h * 0.51} L ${w * 0.62} ${h * 0.75} L ${w * 0.73} ${h * 0.48} L ${w * 0.67} ${h * 0.50} L ${w * 0.73} ${h * 0.30} Z" fill="#FCD34D"/>
        </g>
      </svg>
    `,
    ...
    snowDay: `
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.35" filter="blur(4px)">
        ...
        ${(() => {
          ...
          for (let i = 0; i < 34; i++) {
            ...
            const opacity = 0.5 + seededRandom(i * 53 + 14) * 0.15
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ...
        ${(() => {
          ...
          for (let i = 0; i < 32; i++) {
            ...
            const opacity = 0.4 + seededRandom(i * 61 + 16) * 0.15
    ...
    fogDay: `
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="0" y="${h * 0.32}" width="${w}" height="${h * 0.10}" fill="url(#fogBand)" opacity="0.22"/>
        <rect x="0" y="${h * 0.48}" width="${w}" height="${h * 0.09}" fill="url(#fogBand)" opacity="0.18"/>
        <rect x="0" y="${h * 0.62}" width="${w}" height="${h * 0.11}" fill="url(#fogBand)" opacity="0.15"/>
        <rect x="0" y="${h * 0.76}" width="${w}" height="${h * 0.08}" fill="url(#fogBand)" opacity="0.12"/>
      </svg>
    `,
      ...
      <svg width="${w}" height="${h}" viewBox="0 0 ${w} ${h}" xmlns="http://www.w3.org/2000/svg">
        ${(() => {
          ...
          for (let i = 0; i < 5; i++) {
            ...
            stars.push(`<circle cx="${x}" cy="${y}" r="1" fill="#FFFFFF" opacity="0.15"/>`)
          }
          return stars.join('')
        })()}
        <defs>
        ...
        <rect x="0" y="${h * 0.32}" width="${w}" height="${h * 0.10}" fill="url(#fogBandNight)" opacity="0.18"/>
        <rect x="0" y="${h * 0.48}" width="${w}" height="${h * 0.09}" fill="url(#fogBandNight)" opacity="0.14"/>
        <rect x="0" y="${h * 0.62}" width="${w}" height="${h * 0.11}" fill="url(#fogBandNight)" opacity="0.12"/>
      </svg>
    `
  }
